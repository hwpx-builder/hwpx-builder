...
> 단, 이건 **휠 목록과 코드를 확인한 결과이지 직접 돌려 본 것이 아니다.** 이
> 저장소는 윈도우에서만 실행해 검증했다. 맥이나 리눅스에서 막히면
> [이슈](https://github.com/hwpx-builder/hwpx-builder/issues)로 알려주면
> 고맙겠다. 확인한 것과 확인하지 못한 것을 구분하는 게 이 도구의 방침이라,
> 문서에도 같은 기준을 적용한다.
